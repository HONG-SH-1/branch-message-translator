...
영상 파일: [`video/demo.mp4`](video/demo.mp4)

<!--
  README에서 영상을 '재생 플레이어'로 보이게 하려면 (push 후):
  GitHub 웹 → 이 README.md 편집(연필) → 아래 줄에 video/demo.mp4 파일을 드래그&드롭
  → 자동으로 https://github.com/user-attachments/assets/... 링크가 생기며 인라인 재생됨
-->
